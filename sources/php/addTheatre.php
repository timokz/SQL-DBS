...
// Insert method
$success = $database->insertIntoTheatre($t_name, $Address, $t_capacity, $PRIVATE_OR_PUBLIC);

// Check result
if ($success){
    echo "Theatre '{$t_name}, {$Address}, {$t_capacity}, {$PRIVATE_OR_PUBLIC}' successfully added!'";
}
else{
    echo "Error can't insert Theatre'{$t_name}, {$Address}, {$t_capacity}, {$PRIVATE_OR_PUBLIC}'!";
}
?>
